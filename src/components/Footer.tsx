...
const Footer = () => {
  return (
    <footer className="w-full py-16 px-4 bg-gray-50 border-t border-gray-100 mt-20">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-gray-600 text-lg">
            Email: <a href="mailto:nidhiljabbar@gmail.com" className="text-blue-600 hover:text-blue-700 font-semibold transition-colors">nidhiljabbar@gmail.com</a>
          </p>
        </div>
